...
<body>
	<div style="margin:10px;background-color:#FFFFFF; text-align:left;">
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		   <tr><td class="left_nav_top"><div class="font1">学生</div></td></tr>
		  <tr><td id="navbg1" class="left_nav_closed" ><div class="font1">有关个人</div></td></tr>
		  <tr valign="top" id="submenu1" style="display: none">
		    <td class="left_nav_bgshw" height="125">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/selectDept" target="main">我的资料</a></img></p>
			  <p class="left_nav_link"/><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/" target="main">我的课程</a></img>
			　<p class="left_nav_link"/><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/" target="main">我的参与</a></img>
			　<p class="left_nav_link"/><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/" target="main">我的提问</a></img>
			　<p class="left_nav_link"/><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="dept/" target="main">我的申请</a></img>
			</td>	
		  </tr>
		  <tr><td height="2"></td></tr>
		  
		  <tr><td id="navbg2" class="left_nav_closed" ><div class="font1">信息修改</div></td></tr>
		  <tr valign="top" id="submenu2" style="display: none">
		    <td class="left_nav_bgshw" height="50" >
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/selectJob" target="main">修改密码</a></img></p>
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/addJob?flag=1" target="main">修改资料</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>

		  <tr><td id="navbg3" class="left_nav_closed" ><div class="font1">有关课程</div></td></tr>
		  <tr valign="top" id="submenu3" style="display: none">
		    <td class="left_nav_bgshw" height="25">
			  <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${ctx }/employee/selectEmployee" target="main">申请课程</a></img></p>
			</td>
		  </tr>
		  <tr><td height="2"></td></tr>
